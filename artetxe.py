...
def main():
    ...
    for lang in ['es', 'ca', 'eu']:
        ...
        if True in args.bi:
            ...
            print_prediction(clf, binary_cross_dataset, os.path.join('predictions', lang, 'artetxe-svm', '{0}-bi.txt'.format(args.dataset)))
            print('-binary-')
        ...
        if False in args.bi:
            ...
            print_prediction(clf, fine_cross_dataset, os.path.join('predictions', lang, 'artetxe-svm', '{0}-4cls.txt'.format(args.dataset)))
            print('-fine-')
